...
export default function Dashboard() {
      ...
      try {
        ...
        try {
          const response = await fetch(
            `${apiURL}/api/kterer/generate/business`,
            {
              method: "PUT",
              headers: {
                "Content-Type": "application/json",
    ...
    const repostFood = async () => {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          setPastFood((pastFoods) =>
            pastFoods.filter((food) => food.id !== foodId)
          );
        }
      } catch (error) {
        console.error(`Error: ${error}`);
  ...
  const handleDeletePost = async (foodId: string) => {
    ...
    if (!deleteMode) {
      ...
      setPastFood([
        ...pastFood,
        ...ktererFood.filter((food) => food.id === foodId),
      ]);
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-2xl mx-auto">
          <div className="bg-red-200 px-3.5 py-5 text-red-700 text-center">
            ...
            <h3 className="m-0 font-medium italic">
        ...
        {ktererFood.length > 0 ? (
                ...
                <div key={index} className="relative">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        <DropdownMenuItem
                          onSelect={() => handleEditPost(item.id)}
                        >
                          Edit Post
                        </DropdownMenuItem>
                        <DropdownMenuItem
          ...
          <div className="flex justify-center pb-48 pt-28 space-x-8 items-center">
            ...
            <div className="space-y-3">
              ...
              <Button className="bg-primary-color text-white w-full sm:w-auto hover:bg-primary-color-hover rounded-full">
                <Link href="/kterer/post">Post Food</Link>
              </Button>
            </div>
          </div>
        )}
              ...
              <div key={index} className="relative">
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuItem
                        onSelect={() => handleRepostFood(item.id, index)}
                      >
                        Repost
                      </DropdownMenuItem>
                      <DropdownMenuItem
