      ...
      <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will remove the Kterer from
              your Favourites.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction asChild>
              <button
                ...
                onClick={() => postToDelete && deleteFavourite(postToDelete)}
              >
                Delete
              </button>
            </AlertDialogAction>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 place-items-center gap-8">
          {favourites.map((favourite) => {
            ...
            return (
              <div
                key={favourite.id}
                className="w-40 flex items-center flex-col my-3"
              >
                <Link
                  href={`/kterings/kterer-profile/${favourite.id}?${kterer_id}`}
                >
                  <img
                    src={favourite.profile_image_url || DEFAULT_IMAGE_SRC}
