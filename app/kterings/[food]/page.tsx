            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-24 bg-gray-100 gap-5 p-5 flex items-center w-full">
                    <div className="w-[64px] min-w-[64px] md:w-[128px] md:min-w-[128px]">
                        <img src={ktererInfo?.kterer.profile_image_url} alt="Kterer Profile Picture"
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-color">See
                                    Profile
                                </button>
                            </Link>
                        </div>
