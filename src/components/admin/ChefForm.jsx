...
export default function ChefForm({ initialData = null, isEdit = false }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!CA_PHONE.test(form.phone.trim())) {
      setPhoneError("Use Canadian format: +1XXXXXXXXXX (e.g. +14165551234)");
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onBlur={() => {
                if (form.phone && !CA_PHONE.test(form.phone.trim())) {
                  setPhoneError("Use Canadian format: +1XXXXXXXXXX (e.g. +14165551234)");
                }
              }}
