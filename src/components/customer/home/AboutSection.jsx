...
//     return (
//         <section className="w-full bg-white py-12 px-4 sm:px-6 md:px-12 lg:px-24 font-nunito">
...
//                     <div className="mt-6">
//                         <Link to="/menu">
//                             <button className="w-full sm:w-auto group bg-primary hover:bg-primary/90 text-white text-sm font-medium px-6 py-2 rounded-full transition-transform duration-200 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
//                                 Start Your Order
...
//                     <img
//                         src={mainImg}
//                         alt="Kitchen setup with cooking essentials"
...
export default function AboutSection() {
  return (
    <section className="w-full bg-white py-12 font-nunito">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        {/* LEFT SIDE: TEXT */}
        <div>
          <h3 className="text-primary font-semibold uppercase text-sm sm:text-base tracking-wider mb-2 border-l-4 border-primary pl-3">
