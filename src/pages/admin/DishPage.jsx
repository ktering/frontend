// src/pages/admin/AdminDishDetail.jsx

import { useParams, useNavigate } from "react-router-dom";
import { useEffect, useState } from "react";
import { fetchDishBySlug } from "../../api/dish";
import { ChefHat, Drumstick } from "lucide-react";
...
const DishPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 font-nunito">
      ...
      <button
        onClick={() => navigate("/supervised")}
        className="flex items-center gap-2 mb-6 text-sm px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-100 transition"
      >
